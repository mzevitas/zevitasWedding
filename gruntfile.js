	...
	grunt.initConfig({
		...
		concat : { //name of task
			...
			dist : { //name of job for that task
				src: ['assets/js/libs/jquery.stellar/libs/jquery/jquery-1.4.3.js','assets/js/libs/jquery.stellar/jquery.stellar.min.js','assets/js/libs/jquery.nicescroll/dist/jquery.nicescroll.min.js','assets/js/libs/retinajs/retina.js','assets/js/script/*.js'],
